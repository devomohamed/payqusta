...
export default function PortalHeader({
  ...
  return (
    <header className="app-surface-glass sticky top-0 z-20 border-b px-4 py-3 transition-all">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="relative flex h-9 w-9 items-center justify-center rounded-xl text-gray-400 transition-all hover:bg-black/[0.04] hover:text-gray-600 active:scale-90 dark:hover:bg-white/[0.05] dark:hover:text-gray-300"
          ...
          <button
            onClick={toggleCart}
            className="relative flex h-9 w-9 items-center justify-center rounded-xl text-gray-700 transition-all hover:bg-black/[0.04] active:scale-90 dark:text-gray-200 dark:hover:bg-white/[0.05]"
          ...
          <div className="hidden items-center gap-1 sm:flex">
            ...
            <button
              onClick={toggleTheme}
              className="flex h-9 w-9 items-center justify-center rounded-xl text-gray-400 transition-all hover:bg-black/[0.04] hover:text-gray-600 active:scale-90 dark:hover:bg-white/[0.05] dark:hover:text-gray-300"
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-xl text-gray-400 transition-colors hover:bg-black/[0.04] hover:text-gray-700 active:scale-90 dark:hover:bg-white/[0.05] dark:hover:text-gray-200 sm:hidden"
      ...
      {mobileActionsOpen && (
        <>
          <div
            ...
            aria-hidden="true"
          />
          <div className="app-surface absolute left-4 right-4 top-full z-20 mt-2 rounded-3xl p-3 shadow-2xl sm:hidden">
                ...
                <button
                  ...
                  className={`flex items-center gap-3 rounded-2xl px-3 py-3 text-right text-sm font-bold transition-colors ${
                    action.danger
                      ...
                      : 'text-gray-700 hover:bg-black/[0.02] dark:text-gray-200 dark:hover:bg-white/[0.03]'
                  }`}
                >
