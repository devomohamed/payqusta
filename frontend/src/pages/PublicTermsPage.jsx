    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <section className="grid gap-6 lg:grid-cols-[1.05fr,0.95fr] lg:items-start">
        <div className="text-right">
          ...
          <h1 className="mt-3 text-4xl font-black tracking-tight text-slate-950 dark:text-white sm:text-5xl">شروط استخدام مختصرة وواضحة قبل بدء التشغيل على PayQusta</h1>
      ...
      <section className="mt-10 rounded-[2rem] border border-amber-200 bg-amber-50 p-6 text-right shadow-sm dark:border-amber-400/20 dark:bg-amber-400/10 sm:p-8">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black text-slate-950 dark:text-white">نقاط يجب فهمها قبل الاعتماد الكامل على المنصة</h2>
          </div>
      ...
      <section className="app-surface mt-10 rounded-[2rem] p-6 text-right sm:p-8">
        <div className="grid gap-6 lg:grid-cols-[1.05fr,0.95fr] lg:items-center">
          <div>
            <p className="app-text-muted text-sm font-black uppercase tracking-[0.18em]">الخطوة التالية</p>
            <h2 className="mt-3 text-3xl font-black text-slate-950 dark:text-white">إذا كانت الشروط مناسبة لطريقة عملك، انتقل إلى الديمو أو التسجيل</h2>
