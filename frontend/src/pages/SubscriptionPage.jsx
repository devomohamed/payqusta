  ...
  return (
    <div className="min-h-screen bg-gray-50/30 dark:bg-gray-950/30 app-text-soft">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {currentSubscription && (
          <div className="mt-8 max-w-4xl mx-auto app-surface-muted backdrop-blur-md rounded-2xl shadow-sm p-4 sm:p-6 border border-indigo-100 dark:border-indigo-900/30 flex flex-wrap items-center justify-between gap-4">
            <div>
        ...
        <div className="mt-10 sm:mt-12 max-w-4xl mx-auto app-surface rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8 border border-gray-100/80 dark:border-white/10">
              ...
              {enabledMethods.map((method) => (
                <button
                  ...
                  className={`relative group p-5 rounded-2xl border-2 text-right transition-all duration-300 active:scale-95 ${selectedGateway === method.key
                    ...
                    : 'border-gray-100/80 dark:border-white/10 hover:border-indigo-200 dark:hover:border-indigo-800 app-surface'
                    }`}
                >
        ...
        <div className="mt-12 sm:mt-16 flex flex-col items-center px-4">
          <div className="inline-flex items-center app-surface-muted p-1.5 rounded-2xl border border-gray-200/80 dark:border-white/10 shadow-inner">
            <button
              onClick={() => setBillingCycle('monthly')}
              className={`px-4 sm:px-8 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ${billingCycle === 'monthly'
                ? 'app-surface text-indigo-600 dark:text-indigo-400 shadow-md ring-1 ring-black/5'
          ...
          {orderedPlans.map((plan, index) => {
            ...
            return (
              <div
                ...
                key={plan._id}
                className={`relative flex flex-col rounded-2xl app-surface p-5 shadow-lg ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${isSelectedPlan
              ...
              >
                ...
                <div className="flex items-center justify-between mb-2 mt-1">
                  ...
                  <div className={`p-1.5 rounded-lg ${isSelectedPlan ? 'bg-amber-100 dark:bg-amber-900/40' : isPopular ? 'bg-indigo-100 dark:bg-indigo-900/50' : 'app-surface-muted'}`}>
                ...
                <button
                  ...
                  className={`mt-5 block w-full py-2.5 px-4 rounded-xl text-sm font-bold transition-all shadow-sm active:scale-95 ${isCurrentPlan
                    ? 'app-surface-muted text-gray-500 cursor-not-allowed shadow-none'
                    : isSelectedPlan
          ...
          {manualPaymentInfo && (
            <div className="space-y-4">
              <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800">
                ...
                <div
                  className="mt-4 text-xl font-bold font-mono text-center tracking-wider text-indigo-700 dark:text-indigo-400 cursor-pointer select-all block p-4 app-surface rounded-lg shadow-inner flex items-center justify-center gap-3 transition-colors hover:bg-indigo-50 dark:hover:bg-indigo-900/20"
                  onClick={() => {
              ...
              <div className="pt-4">
                ...
                <div
                  className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-colors ${receiptFile
                    ...
                    : 'border-gray-300 dark:border-white/10 hover:bg-black/[0.03] dark:hover:bg-white/[0.04]'
                    }`}
              ...
              <div className="flex gap-2 pt-4 border-t border-gray-100/80 dark:border-white/10 mt-6">
                <Button
                  variant="ghost"
                  className="flex-1"
                  onClick={() => {
