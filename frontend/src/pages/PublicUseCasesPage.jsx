...
const useCaseSummary = [
  t('public_use_cases_page.ui.k1gw7qa'),
  t('public_use_cases_page.ui.kahc7ah'),
  t('public_use_cases_page.ui.k8h9464'),
];
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="grid gap-6 lg:grid-cols-[0.95fr,1.05fr] lg:items-start">
        <div className="rounded-[2rem] border border-slate-200 bg-slate-950 p-6 text-right text-white shadow-[0_24px_60px_rgba(15,23,42,0.18)] sm:p-8">
          <p className="text-sm font-black uppercase tracking-[0.2em] text-amber-300">{t('public_use_cases_page.ui.ke175x1')}</p>
          ...
          <div className="mt-6">
            ...
            >
              {t('public_use_cases_page.ui.kb77dqk')}
        ...
        <div className="app-surface rounded-[2rem] p-6 text-right sm:p-8">
          <p className="app-text-muted text-sm font-black uppercase tracking-[0.18em]">{t('public_use_cases_page.ui.k9i4sif')}</p>
          <h2 className="mt-3 text-3xl font-black text-slate-950 dark:text-white">{t('public_use_cases_page.ui.kkjhzqe')}</h2>
      ...
      <div className="app-surface mt-10 rounded-[2rem] bg-gradient-to-br from-emerald-50 via-white to-amber-50 p-6 text-right sm:p-8 dark:from-slate-950 dark:via-slate-900 dark:to-amber-950/20">
        <div className="grid gap-6 lg:grid-cols-[1.05fr,0.95fr] lg:items-center">
          <div>
            <p className="app-text-muted text-sm font-black uppercase tracking-[0.18em]">{t('public_use_cases_page.ui.ktyyvg7')}</p>
            <h3 className="mt-3 text-3xl font-black text-slate-950 dark:text-white">{t('public_use_cases_page.ui.kn35hia')}</h3>
            <p className="app-text-soft mt-3 text-base leading-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-end">
            ...
            >
              {t('public_use_cases_page.ui.kluu3hg')}
            </Link>
            <Link
            ...
            >
              {t('public_use_cases_page.ui.kl6w4j0')}
              <ArrowLeft className="h-4 w-4" />
            </Link>
          </div>
        </div>
