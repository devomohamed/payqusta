...
router.post('/', authorize('vendor', 'admin'), checkPermission('branches', 'create'), checkLimit('store'), auditLog('create', 'branch'), branchController.createBranch);
router.put('/:id', authorize('vendor', 'admin'), checkPermission('branches', 'update'), auditLog('update', 'branch'), branchController.updateBranch);
router.delete('/:id', authorize('vendor', 'admin'), checkPermission('branches', 'delete'), auditLog('delete', 'branch'), branchController.deleteBranch);
