...
router.post('/', authorize('vendor', 'admin'), checkPermission('products', 'create'), uploadMultiple, productValidations.create, checkLimit('product'), auditLog('create', 'product'), productController.create);
