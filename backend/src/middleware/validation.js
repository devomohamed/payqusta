...
const productValidations = {
  create: [
    ...
    body('category').optional({ checkFalsy: true }).isMongoId().withMessage('قسم غير صحيح'),
    body('subcategory').optional({ checkFalsy: true }).isMongoId().withMessage('قسم فرعي غير صحيح'),
